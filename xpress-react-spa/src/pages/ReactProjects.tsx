      ...
      <div className="pt-[65px] flex h-screen overflow-hidden">
        ...
        <div className="relative flex-1 overflow-hidden">
          {loading ? (
            <div className="flex items-center justify-center h-full">
              <span className="text-[#4a4e4a]/40 text-sm animate-pulse">
                Đang tải...
              </span>
            </div>
          ) : !active ? (
            <div className="flex flex-col items-center justify-center h-full gap-4">
              ...
              <p className="text-[#4a4e4a]/50 text-sm">
                Chưa có dự án React nào được migrate.
              </p>
            </div>
          ) : (
            <>
        ...
        <div className="w-[320px] shrink-0 flex flex-col overflow-y-auto border-l border-[#e8e4dc] bg-white/60 backdrop-blur-sm">
          <div className="px-5 py-4 border-b border-[#e8e4dc] bg-white/80 sticky top-0 z-10">
            <h2 className="text-[#2e3230] font-headline font-bold text-base">
              React Projects
            </h2>
            <p className="text-[#4a4e4a]/50 text-xs mt-0.5">
              {items.length} dự án đã migrate
            </p>
          </div>

          {loading ? (
            <div className="flex-1 flex items-center justify-center">
              <span className="text-[#4a4e4a]/30 text-xs animate-pulse">
                Đang tải...
              </span>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative w-[120px] h-[80px] shrink-0 rounded-xl overflow-hidden border border-[#e8e4dc]">
                      ...
                      />
                      <span
                        className={`absolute bottom-1 right-1.5 text-[10px] font-bold leading-none px-1 py-0.5 rounded ${
                          isActive
                    ...
                    <div className="flex flex-col justify-center min-w-0">
                      <p
                        className={`text-sm font-semibold truncate leading-snug ${
                          isActive
                            ? "text-[#2e3230]"
                            : "text-[#4a4e4a] group-hover:text-[#2e3230]"
                        }`}
                      >
